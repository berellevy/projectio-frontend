...
const renderCartItems = (items) => {
	...
	items.forEach(item => {
 	...
 	const createCartItem = (item) => {
		...
		let deleteButton = createElem("button", {className: 'bi bi-x delete-cart-item', innerHTML: `<svg class="delete-cart-item" width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-x-circle-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
